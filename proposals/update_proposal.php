    ...
    <script>
        function confirmDelete() {
            if (confirm("Delete this record?")) {
                ...
                if (idParam !== null) {
                    window.open("delete_proposal.php?id=" + idParam, "Deleting ID " + idParam);
                }
            }
        }
    </script>
...
$output_form = function($id, $title, $blurb, $goals, $locations, $resparty, $resources, $steps, $outcome, $arg1, $reb1, $inv_arg1, $inv_reb1, $arg2, $reb2, $inv_arg2, $inv_reb2, $arg3, $reb3, $inv_arg3, $inv_reb3){

    echo <<<EOF
    <form action="update_proposal.php" method="post">
    ...
    <input type="text" id="resources" name="resources" value="$resources">
    <br>
    <label for="steps">Steps:</label>
    <textarea id="steps" name="steps" rows="3" cols="30" maxlength="250">$steps</textarea>
    <label for="outcome">Projected Outcome:</label>
    <textarea id="outcome" name="outcome" rows="3" cols="30" maxlength="250">$outcome</textarea>
    <br>
    ...
    <textarea id="inv_reb3" name="inv_reb3" rows="3" cols="30" maxlength="500">$inv_arg3</textarea>
    <br>
...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $output_form ($id, $title, $blurb, $goals, $locations, $resparty, $resources, $steps, $outcome, $arg1, $reb1, $inv_arg1, $inv_reb1, $arg2, $reb2, $inv_arg2, $inv_reb2, $arg3, $reb3, $inv_arg3, $inv_reb3);
    ...
    $sql = "UPDATE `proposals` SET `title`=?,`blurb`=?,`goals`=?,`locations`=?,`resparty`=?,`resources`=?,`steps`=?,`outcome`=?,`arg1`=?,`reb1`=?,`inv_arg1`=?,`inv_reb1`=?, `arg2`=?,`reb2`=?,`inv_arg2`=?,`inv_reb2`=?,`arg3`=?,`reb3`=?,`inv_arg3`=?,`inv_reb3`=? WHERE `id` =?";
    $result = $conn->execute_query($sql, [$title, $blurb, $goals, $locations, $resparty, $resources, $steps, $outcome, $arg1, $reb1, $inv_arg1, $inv_reb1, $arg2, $reb2, $inv_arg2, $inv_reb2, $arg3, $reb3, $inv_arg3, $inv_reb3, $id]);
